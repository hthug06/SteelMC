...
///
/// Direct equivalent of vanilla's `Shapes.faceShapeOccludes(shape, occluder)`
/// after each block state has already selected the relevant
/// `getFaceOcclusionShape(direction)`.
#[must_use]
